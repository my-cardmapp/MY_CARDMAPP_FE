...
export const naverLocalSearchHandlers = [
  ...
  // 실제 API 사용: passthrough로 실제 네이버 서버에 요청 전달
  http.get('https://openapi.naver.com/v1/search/local.json', () => {
    console.log('[MSW] Passing through to real Naver Local Search API')
    return passthrough()
  })

  /* Mock 데이터 사용 시 아래 코드 활성화
